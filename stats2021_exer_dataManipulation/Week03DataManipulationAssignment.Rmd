...
* What level of measurement is the new LOSS_total
    ...
    + Answer: Interval (but we could designate it as integer in Jamovi to run more tests on it.)
...
* How do the z-scores compare between the sum scores and the mean scores?
    ...
    + Answer: The mean is able to adjust for missing values better than sum scoring.
...
# this code came off of line 133 {r, eval=FALSE}
