...
-   List each variable and the level of measurement. Note if there are
    ...
    -   research - nominall, no issues noted
    ...
    -   first3 - ordinal, no issues noted
...
-   What level of measurement is the new LOSS\_total
    ...
    -   Answer: Interval (but we could designate it as integer in Jamovi
...
-   How do the z-scores compare between the sum scores and the mean
    ...
    -   Answer: The mean is able to adjust for missing values better
        than sum scoring.
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive: it’s above the mean
    -   negative: it’s below the mean
...
Save this assignment as a markdown file. \# this code came off of line
133 {r, eval=FALSE}
